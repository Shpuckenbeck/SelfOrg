...
namespace SelfOrg.Migrations
{
    ...
    [Migration("20171205174217_isitnotrequirednow")]
    partial class isitnotrequirednow
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SelfOrg.Models.CatCrit", b =>
                {
                    b.Property<int>("CatCritId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SelfOrg.Models.CommRate", b =>
                {
            ...
            modelBuilder.Entity("SelfOrg.Models.CommRate", b =>
                {
                    b.HasOne("SelfOrg.Models.Comment", "Comment")
                        .WithMany()
