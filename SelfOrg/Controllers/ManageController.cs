...
namespace SelfOrg.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        /// На данный момент единственный способ получить туда доступ - это ввести полный адрес в адресной строке
        /// Производится проверка на роль, доступно только администраторам
        /// </summary>
        /// <returns></returns>
